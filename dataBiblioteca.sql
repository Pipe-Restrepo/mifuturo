...
alter table Persona add column email varchar(255);
...
insert into Persona (id, nombre, apellido, tipo, email) values (1,'Julio', 'Perez', 'Usuario', 'corre@coreo.com');
insert into Persona (id, nombre, apellido, tipo, email) values (2,'Lilo', 'Suarez', 'Usuario', 'corre@coreo.com');
insert into Persona (id, nombre, apellido, tipo, email) values (3,'Jose', 'Rojas', 'Usuario', 'corre@coreo.com');
insert into Persona (id, nombre, apellido, tipo,email) values (4,'Nino', 'Peña', 'Usuario', 'corre@coreo.com');
insert into Persona (id, nombre, apellido, tipo,email) values (5,'Jorge', 'Castro', 'Usuario', 'corre@coreo.com');
