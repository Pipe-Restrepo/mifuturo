...
public class Main {
    public static void main(String[] args) {
        ...
        Usuario usuario = new Usuario("Tobias", "Arango", 1980);
        Usuario usuario1 = new Usuario("Nino", "Bravo", 1981);
        ...
        bibliotecario.devolverLibro(libroIV, usuario);
